...
!function () {
    ...
    function h(t, e, n) {
        const o = t.icons, i = t.aliases || Object.create(null);
        let r = {};
    ...
    function p(t, e) {
        ...
        const o = function (t, e) {
            const n = t.icons, o = t.aliases || Object.create(null), i = Object.create(null);
    ...
    z[""] = R({resources: ["https://api.iconify.design"].concat(q)});
    ...
    const G = "iconify2", V = "iconify", K = V + "-count", W = V + "-version", X = 36e5, Y = 168;
    ...
    const it = {local: !0, session: !0}, rt = {local: new Set, session: new Set};
    let st = !1;
    ...
    function ut(t, e) {
        ...
        const i = Math.floor(Date.now() / X) - Y, r = t => {
            const o = V + t.toString(), r = Z(n, o);
            if ("string" == typeof r) {
                try {
    ...
    function ft(t, e) {
        function n(n) {
            ...
            const i = rt[n];
            let r;
            if (i.size) i.delete(r = Array.from(i).shift()); else if (r = ot(o), !nt(o, r + 1)) return;
        ...
        st || lt(), e.lastModified && !function (t, e) {
            ...
            if (n && n >= e) return n === e;
            if (t.lastModifiedCached = e, n) for (const n in it) ut(n, (n => {
                const o = n.data;
    ...
    const vt = /(-?[0-9.]*[0-9]+[0-9.]*)/g, xt = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
    ...
    const Pt = {"background-color": "currentColor"}, Nt = {"background-color": "transparent"},
        Lt = {image: "var(--svg)", repeat: "no-repeat", size: "100% 100%"},
        Rt = {"-webkit-mask": Pt, mask: Pt, background: Nt};
    for (const t in Rt) {
        const e = Rt[t];
    ...
    function Dt(t, e) {
        const o = e.icon.data, i = e.customisations, r = jt(o, i);
        ...
        if ("svg" === s) c = function (t) {
            ...
            const r = t.attributes, s = 'url("' + (u = Ft(i, {
                ...r,
                width: e.width + "",
                height: e.height + ""
            }), "data:image/svg+xml," + function (t) {
                return t.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ")
            }(u) + '")'), c = o.style, a = {"--svg": s, width: zt(r.width), height: zt(r.height), ...n ? Pt : Nt};
            var u;
    ...
    !function (t = "iconify-icon") {
        ...
        const i = ["icon", "mode", "inline", "width", "height", "rotate", "flip"], r = class extends n {
            ...
            constructor() {
                super();
                const t = this._shadowRoot = this.attachShadow({mode: "open"}), e = bt(this);
                Tt(t, e), this._state = Ut({value: ""}, e), this._queueCheck()
            }
