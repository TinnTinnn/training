...
!function (n) {
    ...
    var p, e, t, w = function (t, v) {
        ...
        J = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")", "g"),
        q = /['\u00A0,$Â£â‚¬Â¥%\u2009\u202F\u20BD\u20a9\u20BArfkÉƒÎž]/gi, h = function (t) {
            return !t || !0 === t || "-" === t
        }, $ = function (t, e) {
    ...
    function Nt(t, e, n, a) {
        return t = e ? t : Ot(t), n && (t = "^(?=.*?" + P.map(t.match(/["\u201C][^"\u201D]+["\u201D]|[^ ]+/g) || [""], function (t) {
            var e;
            return '"' === t.charAt(0) ? t = (e = t.match(/^"(.*)"$/)) ? e[1] : t : "â€œ" === t.charAt(0) && (t = (e = t.match(/^\u201C(.*)\u201D$/)) ? e[1] : t), t.replace('"', "")
    ...
    }), w.version = "1.13.10", w.settings = [], w.models = {}, w.models.oSearch = {
        bCaseInsensitive: !0,
        sSearch: "",
        bRegex: !1,
        bSmart: !0,
