!function (t, e) {
    ...
    e.locale("en"), t.fn[a] = function (e, a) {
        ...
        init: function () {
            ...
            } else this.minDate = this.params.minDate; else null === this.params.minDate && (this.minDate = null);
            ...
            } else this.maxDate = this.params.maxDate; else null === this.params.maxDate && (this.maxDate = null);
            ...
            for (var e = this.createSVGClock(!0), i = 0; 12 > i; i++) {
                var a = -(162 * Math.sin(2 * -Math.PI * (i / 12))), s = -(162 * Math.cos(2 * -Math.PI * (i / 12))),
                    n = this.currentDate.format(t) == i ? "#8BC34A" : "transparent",
                    r = this.currentDate.format(t) == i ? "#fff" : "#000", h = this.createSVGElement("circle", {
                        id: "h-" + i,
            ...
            if (!this.params.shortTime) {
                for (var i = 0; 12 > i; i++) {
                    var a = -(110 * Math.sin(2 * -Math.PI * (i / 12))), s = -(110 * Math.cos(2 * -Math.PI * (i / 12))),
            ...
            for (var t = this.createSVGClock(!1), e = 0; 60 > e; e++) {
                var i = e % 5 === 0 ? 162 : 158, a = e % 5 === 0 ? 30 : 20,
                    s = -(i * Math.sin(2 * -Math.PI * (e / 60))), n = -(i * Math.cos(2 * -Math.PI * (e / 60))),
            ...
            for (var e = 0; 60 > e; e++) if (e % 5 === 0) {
                var s = -(162 * Math.sin(2 * -Math.PI * (e / 60))), n = -(162 * Math.cos(2 * -Math.PI * (e / 60))),
                    r = this.currentDate.format("m") == e ? "#fff" : "#000", d = this.createSVGElement("text", {
                        id: "tm-" + e,
            ...
            var t = this.currentDate.hour(), e = this.currentDate.minute(), i = this.$dtpElement.find(".hour-hand");
            ...
            var e = this.params.shortTime ? -120 : -90,
                i = this.createSVGElement("svg", {"class": "svg-clock", viewBox: "0,0,400,400"}),
                a = this.createSVGElement("g", {transform: "translate(200,200) "}),
                s = this.createSVGElement("circle", {r: "192", fill: "#eee", stroke: "#bdbdbd", "stroke-width": 2}),
            ...
            if (null !== t) {
                var a = e(t).locale(this.params.lang).startOf("month"),
                    s = e(t).locale(this.params.lang).endOf("month"), n = a.format("d");
                i.week = this.days, i.days = [];
                for (var r = a.date(); r <= s.date(); r++) {
                    if (r === a.date()) {
                        var h = i.week.indexOf(n.toString());
                        if (h > 0) for (var d = 0; h > d; d++) i.days.push(0)
                    }
