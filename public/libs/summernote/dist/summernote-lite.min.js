...
!function (t, e) {
    ...
    return (() => {
        ...
        var e = {
            9770: (t, e, o) => {
                var n = o(1145), i = o.n(n);
                i().summernote = i().summernote || {lang: {}}, i().extend(i().summernote.lang, {
                    "en-US": {
                        font: {
                            bold: "Bold",
                            italic: "Italic",
        ...
        return (() => {
            n.r(i);
            var t = n(1145), e = n.n(t), o = (n(9770), ["sans-serif", "serif", "monospace", "cursive", "fantasy"]);
            ...
            const f = {
                ...
                isFontInstalled: function (t) {
                    var e = "Comic Sans MS" === t ? "Courier New" : "Comic Sans MS", o = "mmmmmmmmmmwwwww",
            ...
            const y = {
                head: m, last: g, initial: function (t) {
                    return t.slice(0, t.length - 1)
                }, tail: b, prev: function (t, e) {
                    if (t && t.length && e) {
                        var o = t.indexOf(e);
            ...
            function at(t, e) {
                ...
                var r = t.node.childNodes[t.offset], a = q(t.node.cloneNode(!1), t.node);
            ...
            const ht = {
                ...
                splitPoint: function (t, e) {
                    var o, n, i = e ? E : H, r = K(t.node, i), a = y.last(r) || t.node;
                ...
                posFromPlaceholder: function (t) {
                    var o = e()(t), n = o.offset(), i = o.outerHeight(!0);
            ...
            var pt = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "triggerEvent", value: function () {
                        var t = y.head(arguments), e = y.tail(y.from(arguments)),
                    ...
                    key: "createInvokeHandler", value: function (t, o) {
                        var n = this;
                        return function (i) {
                            i.preventDefault();
                            var r = e()(i.target);
                    ...
                    key: "invoke", value: function () {
                        var t = y.head(arguments), e = y.tail(y.from(arguments)), o = t.split("."), n = o.length > 1,
                            i = n && y.head(o), r = n ? y.last(o) : y.head(o), a = this.modules[i || "editor"];
            ...
            function mt(t, e) {
                var o, n, i = t.parentElement(), r = document.body.createTextRange(), a = y.from(i.childNodes);
            ...
            function gt(t) {
                var e = document.body.createTextRange(), o = function t(e, o) {
                    var n, i;
                    if (ht.isText(e)) {
                        var r = ht.listPrev(e, v.not(ht.isText)), a = y.last(r).previousSibling;
            ...
            e().fn.extend({
                summernote: function () {
                    var t = e().type(y.head(arguments)), o = "string" === t, n = "object" === t,
                ...
                return o = t, n = [{
                    ...
                    key: "normalize", value: function () {
                        var e = function (t, e) {
                            ...
                            var o = ht.ancestor(t.node, ht.isBlock), n = !1;
                            if (!n) {
                    ...
                    key: "expand", value: function (e) {
                        var o = ht.ancestor(this.sc, e), n = ht.ancestor(this.ec, e);
                    ...
                    key: "deleteContents", value: function () {
                        ...
                        var o = this.splitText(), n = o.nodes(null, {fullyContains: !0}),
                    ...
                    key: "pasteHTML", value: function (t) {
                        t = e().trim(t);
                        var o = e()("<div></div>").html(t)[0], n = y.from(o.childNodes), i = this, r = !1;
                    ...
                    key: "getWordsMatchRange", value: function (e) {
                        var o = this.getEndPoint(), n = ht.prevPointUntil(o, (function (n) {
            ...
            const kt = {
                create: function (t, e, o, n) {
                    ...
                    var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = this.createFromNode(t);
                    return o.collapse(e)
                    ...
                    var e = t, o = 0, n = t, i = ht.nodeLength(n);
                    ...
                    var o = ht.fromOffsetPath(t, e.s.path), n = e.s.offset, i = ht.fromOffsetPath(t, e.e.path),
                        r = e.e.offset;
                    return new bt(o, n, i, r)
                }, createFromParaBookmark: function (t, e) {
                    var o = t.s.offset, n = t.e.offset, i = ht.fromOffsetPath(y.head(e), t.s.path),
            ...
            const wt = {
                ...
                }, nameFromCode: v.invertObject(yt), code: yt
            };
            ...
            var Tt = function () {
                ...
                var o, n, i;
                return o = t, n = [{
                    key: "jQueryCSS", value: function (t, o) {
                        var n = {};
                        return e().each(o, (function (e, o) {
                            n[o] = t.css(o)
                        })), n
                    ...
                    key: "stylePara", value: function (t, o) {
                        e().each(t.nodes(ht.isPara, {includeAncestor: !0}), (function (t, n) {
                            e()(n).css(o)
                        }))
                    }
                }, {
                    key: "styleNodes", value: function (t, o) {
                        t = t.splitText();
                        var n = o && o.nodeName || "SPAN", i = !(!o || !o.expandClosestSibling),
                        ...
                        if (i) {
                            ...
                            return s.map((function (t) {
                                var o = ht.withClosestSiblings(t, a), n = y.head(o), i = y.tail(o);
                    ...
                    key: "current", value: function (t) {
                        var o = e()(ht.isElement(t.sc) ? t.sc : t.sc.parentNode), n = this.fromNode(o);
                        try {
                            n = e().extend(n, {
            ...
            var $t = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "indent", value: function (t) {
                        var o = this, n = kt.create(t).wrapBodyInlineWithPara(),
                            i = n.nodes(ht.isPara, {includeAncestor: !0}), r = y.clusterBy(i, v.peq2("parentNode"));
                    ...
                    key: "toggleList", value: function (t, o) {
                        var n = this, i = kt.create(o).wrapBodyInlineWithPara(),
                            r = i.nodes(ht.isPara, {includeAncestor: !0}), a = i.paraBookmark(r),
                    ...
                    key: "wrapList", value: function (t, e) {
                        var o = y.head(t), n = y.last(t), i = ht.isList(o.previousSibling) && o.previousSibling,
                    ...
                    key: "releaseList", value: function (t, o) {
                        var n = this, i = [];
                        return e().each(t, (function (t, r) {
                            var a = y.head(r), s = y.last(r), l = o ? ht.lastAncestor(a, ht.isList) : a.parentNode,
                                c = l.parentNode;
                            if ("LI" === l.parentNode.nodeName) r.map((function (t) {
                                ...
                                }, {isSkipPaddingBlankHTML: !0}) : null, d = ht.splitTree(l, {
                                    node: a.parentNode,
            ...
            var It = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "insertParagraph", value: function (t, o) {
            ...
            Rt.where = {Row: 0, Column: 1}, Rt.requestAction = {Add: 0, Delete: 1}, Rt.resultAction = {
                Ignore: 0,
                SubtractSpanCount: 1,
                RemoveCell: 2,
                AddCell: 3,
            ...
            var Lt = function () {
                ...
                return o = t, n = [{
                    key: "tab", value: function (t, e) {
                        var o = ht.ancestor(t.commonAncestor(), ht.isCell), n = ht.ancestor(o, ht.isTable),
                            i = ht.listDescendant(n, ht.isCell), r = y[e ? "prev" : "next"](i, o);
                        r && kt.create(r, 0).select()
                    }
                }, {
                    key: "addRow", value: function (t, o) {
                    ...
                    key: "addCol", value: function (t, o) {
                        var n = ht.ancestor(t.commonAncestor(), ht.isCell), i = e()(n).closest("tr");
                        e()(i).siblings().push(i);
                    ...
                    key: "createTable", value: function (t, o, n) {
            ...
            var Ft = function () {
                function t(o) {
                    ...
                    this.insertParagraph = this.wrapCommand((function () {
                        ...
                        var o = t.url, i = t.text, r = t.isNewWindow, a = t.checkProtocol,
                            s = t.range || n.getLastRange(), l = i.length - s.toString().length;
                ...
                return o = t, n = [{
                    ...
                    key: "handleKeyMap", value: function (t) {
                        var e = this.options.keyMap[f.isMac ? "mac" : "pc"], o = [];
                        ...
                        } else wt.isEdit(t.keyCode) && this.afterCommand(); else this.afterCommand();
                        return !1
                    }
                }, {
                    ...
                    key: "insertImage", value: function (t, o) {
                        var n, i = this;
                    ...
                    key: "onFormatBlock", value: function (t, o) {
                        if (document.execCommand("FormatBlock", !1, f.isMSIE ? "<" + t + ">" : t), o && o.length && (o[0].tagName.toUpperCase() !== t.toUpperCase() && (o = o.find(t)), o && o.length)) {
                            var n = this.createRange(), i = e()([n.sc, n.ec]).closest(t);
                            i.removeClass();
                            var r = o[0].className || "";
                            r && i.addClass(r)
                        }
                    ...
                    key: "fontStyling", value: function (t, o) {
                    ...
                    key: "getLinkInfo", value: function () {
                        var t = this.getLastRange().expand(ht.isAnchor), o = e()(y.head(t.nodes(ht.isAnchor))),
            ...
            var Ht = function () {
                ...
                return e = t, (o = [{
                    ...
                    key: "pasteByEvent", value: function (t) {
                        var e = this, o = t.originalEvent.clipboardData;
            ...
            var zt = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "attachDragAndDropEvent", value: function () {
                        var t = this, o = e()(), n = this.$dropzone.find(".note-dropzone-message");
                        ...
                        this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown", (function (e) {
                            ...
                            var o = t.$editable.offset().top - t.$document.scrollTop(),
                                n = t.$codable.offset().top - t.$document.scrollTop(), i = function (e) {
                                    var i = e.clientY - (o + 24), r = e.clientY - (n + 24);
            ...
            var Gt = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "update", value: function (t, o) {
                        if (this.context.isDisabled()) return !1;
                        var n = ht.isImg(t), i = this.$handle.find(".note-control-selection");
                        if (this.context.invoke("imagePopover.update", t, o), n) {
                            var r = e()(t), a = r.position(), s = {
                    ...
                    return o = t, (n = [{
                        ...
                        key: "replace", value: function () {
                            if (this.lastWordRange) {
                                var t = this.lastWordRange.toString(), o = t.match(Zt);
                                if (o && (o[1] || o[2])) {
                                    var n = o[1] ? t : "http://" + t,
            ...
            var re = function () {
                ...
                return o = t, n = [{
                    key: "representShortcut", value: function (t) {
                        ...
                        return this.options.shortcuts && e ? (f.isMac && (e = e.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
                    }
                }, {
                    ...
                    key: "colorPalette", value: function (t, o, n, i) {
                        var r = this;
                        return this.ui.buttonGroup({
                            ...
                            children: [this.button({
                                ...
                                click: function (t) {
                                    ...
                                    }) : n ? r.context.invoke("editor.color", {backColor: o.attr("data-backColor")}) : i && r.context.invoke("editor.color", {foreColor: o.attr("data-foreColor")})
                                },
                                callback: function (t) {
                                ...
                                click: function (o) {
                                    o.stopPropagation();
                                    var n = e()("." + t).find(".note-dropdown-menu"), i = e()(o.target),
                                        a = i.data("event"), s = i.attr("data-value");
                                    if ("openPalette" === a) {
                                        var l = n.find("#" + s),
                    ...
                    key: "updateCurrentStyle", value: function (t) {
                        var o = t || this.$toolbar, n = this.context.invoke("editor.currentStyle");
                        ...
                        if (n["line-height"]) {
                            ...
                            o.find(".dropdown-line-height a").each((function (t, o) {
                                var n = e()(o), i = e()(o).data("value") + "" == l + "";
                                n.toggleClass("checked", i)
                            })), o.find(".note-current-line-height").text(l)
                        }
                    }
                }, {
                    key: "updateBtnStates", value: function (t, o) {
                        var n = this;
                    ...
                    key: "tableMoveHandler", value: function (t) {
                        var o, n = e()(t.target.parentNode), i = n.next(),
                        ...
                        var c = Math.ceil(o.x / 18) || 1, u = Math.ceil(o.y / 18) || 1;
                        a.css({
                            width: c + "em",
                            height: u + "em"
                        }), r.data("value", c + "x" + u), c > 3 && c < this.options.insertTableMaxSize.col && s.css({width: c + 1 + "em"}), u > 3 && u < this.options.insertTableMaxSize.row && s.css({height: u + 1 + "em"}), i.html(c + " x " + u)
                    }
            ...
            var se = function () {
                ...
                return o = t, (n = [{
                    ...
                    key: "followScroll", value: function () {
                        ...
                        var t = this.$editor.outerHeight(), o = this.$editor.width(), n = this.$toolbar.height(),
                            i = this.$statusbar.height(), r = 0;
                ...
                return o = t, (n = [{
                    ...
                    key: "showLinkDialog", value: function (t) {
                        ...
                        return e().Deferred((function (e) {
                            var n = o.$dialog.find(".note-link-text"), i = o.$dialog.find(".note-link-url"),
                    ...
                    key: "update", value: function () {
                        if (this.context.invoke("editor.hasFocus")) {
                            ...
                            if (t.isCollapsed() && t.isOnAnchor()) {
                                var o = ht.ancestor(t.sc, ht.isAnchor), n = e()(o).attr("href");
                                this.$popover.find("a").attr("href", n).text(n);
                                var i = ht.posFromPlaceholder(o), r = e()(this.options.container).offset();
            ...
            var ve = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "update", value: function (t, o) {
                        if (ht.isImg(t)) {
                            var n = e()(t).offset(), i = e()(this.options.container).offset(), r = {};
            ...
            var ge = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "update", value: function (t) {
                        ...
                        if (o) {
                            var n = ht.posFromPlaceholder(t), i = e()(this.options.container).offset();
                ...
                return o = t, (n = [{
                    ...
                    key: "createVideoNode", value: function (t) {
                        var o,
                            ...
                            f = t.match(/^.+.(mp4|m4v)$/), p = t.match(/^.+.(ogg|ogv)$/), v = t.match(/^.+.(webm)$/),
            ...
            var we = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "createShortcutList", value: function () {
                        var t = this, o = this.options.keyMap[f.isMac ? "mac" : "pc"];
                        return Object.keys(o).map((function (n) {
                            var i = o[n], r = e()('<div><div class="help-list-item"></div></div>');
                ...
                return o = t, (n = [{
                    ...
                    key: "update", value: function (t) {
                        ...
                        if (!o.range || o.range.isCollapsed() && !t) this.hide(); else {
                            var n = {left: this.pageX, top: this.pageY}, i = e()(this.options.container).offset();
                            n.top -= i.top, n.left -= i.left, this.$popover.css({
                                display: "block",
            ...
            var Te = function () {
                ...
                return o = t, n = [{
                    ...
                    key: "createItemTemplates", value: function (t, o) {
                        var n = this.hints[t];
                    ...
                    key: "createGroup", value: function (t, o) {
                        var n = this, i = e()('<div class="note-hint-group note-hint-group-' + t + '"></div>');
            ...
            e().summernote = e().extend(e().summernote, {
                version: "0.8.20", plugins: {}, dom: ht, range: kt, lists: y, options: {
            ...
            const Re = function () {
                function t(o, n) {
                    if (function (t, e) {
                        ...
                        var i = this.show.bind(this), r = this.hide.bind(this), a = this.toggle.bind(this);
                ...
                return o = t, (n = [{
                    key: "show", value: function () {
                        var t = this.$node, o = t.offset(), n = e()(this.options.target).offset();
                        o.top -= n.top, o.left -= n.left;
                        var i = this.$tooltip, r = this.options.title || t.attr("title") || t.data("title"),
                            a = this.options.placement || t.data("placement");
                        i.addClass(a), i.find(".note-tooltip-content").text(r), i.appendTo(this.options.target);
                        var s = t.outerWidth(), l = t.outerHeight(), c = i.outerWidth(), u = i.outerHeight();
                        "bottom" === a ? i.css({
                            top: o.top + l,
                            left: o.left + (s / 2 - c / 2)
                        }) : "top" === a ? i.css({
                            ...
                            top: o.top + (l / 2 - u / 2),
                            left: o.left - c
                        }) : "right" === a && i.css({top: o.top + (l / 2 - u / 2), left: o.left + s}), i.addClass("in")
                    }
                }, {
                    key: "hide", value: function () {
                        var t = this;
            ...
            var Ae = function () {
                function t(o, n) {
                    !function (t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this.$button = o, this.options = e().extend({}, {target: n.container}, n), this.setEvent()
                }
                ...
                return o = t, (n = [{
                    ...
                    key: "show", value: function () {
                        ...
                        var t = this.$button.next(), o = t.offset(), n = t.outerWidth(), i = e()(window).width(),
            ...
            var Be = Ie('<div class="note-editor note-frame"></div>'),
                ...
                qe = Ie('<button type="button" class="note-btn" tabindex="-1"></button>', (function (t, o) {
                    o && o.tooltip && (t.attr({"aria-label": o.tooltip}), t.data("_lite_tooltip", new Re(t, {
                        title: o.tooltip,
                        container: o.container
                    })).on("click", (function (t) {
                        e()(t.currentTarget).data("_lite_tooltip").hide()
                    }))), o.contents && t.html(o.contents), o && o.data && "dropdown" === o.data.toggle && t.data("_lite_dropdown", new Fe(t, {container: o.container})), o && o.codeviewKeepButton && t.addClass("note-codeview-keep")
                })), _e = Ie('<div class="note-dropdown-menu" role="list"></div>', (function (t, o) {
                    var n = Array.isArray(o.items) ? o.items.map((function (t) {
                        var n = "string" == typeof t ? t : t.value || "", i = o.template ? o.template(t) : t,
                    ...
                    t.html(n).attr({"aria-label": o.title}), t.on("click", "> .note-dropdown-item", (function (t) {
                        var n = e()(this), i = n.data("item"), r = n.data("value");
                    ...
                    return Ve([qe({
                        ...
                        tooltip: t.tooltip,
                        data: {toggle: "dropdown"}
                    }), _e([Ve({className: "note-align", children: t.items[0]}), Ve({
                        className: "note-list",
                        children: t.items[1]
                    })])]).render()
                }, Je = function (t) {
                    return Ve([qe({
                        ...
                        callback: function (o) {
                            o.find(".note-dimension-picker-mousecatcher").css({
                                ...
                                !function (t, o, n) {
                                    var i, r = e()(t.target.parentNode), a = r.next(),
                                    ...
                                    var d = Math.ceil(i.x / 18) || 1, h = Math.ceil(i.y / 18) || 1;
                                    l.css({
                                        width: d + "em",
                                        height: h + "em"
                                    }), s.data("value", d + "x" + h), d > 3 && d < o && c.css({width: d + 1 + "em"}), h > 3 && h < n && c.css({height: h + 1 + "em"}), a.html(d + " x " + h)
                                }(o, t.col, t.row)
                            }))
                        }
                    }).render()
                    ...
                    return Ve({
                        ...
                        children: [qe({
                            ...
                            click: function (n) {
                                var i = e()(n.target), r = i.data("event"), a = i.data("value"),
                ...
                oo = Ie('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', (function (t, e) {
                    e.fade && t.addClass("fade"), t.attr({"aria-label": e.title}), t.html(['<div class="note-modal-content">', e.title ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + e.title + "</h4></div>" : "", '<div class="note-modal-body">' + e.body + "</div>", e.footer ? '<div class="note-modal-footer">' + e.footer + "</div>" : "", "</div>"].join("")), t.data("modal", new He(t, e))
                })), no = function (t) {
