!function (t) {
    ...
    function g(t, e) {
        ...
        e.min, e.max, t.spectrum = new l(e, t.snap, t.singleStep)
    }
    ...
    function vt(e) {
        var r = {
            ...
            ariaFormat: u,
            format: u,
            isMinMaxEqual: e.range.min === e.range.max
        }, n = {
            step: {r: !1, t: h},
            start: {r: !0, t: v},
            connect: {r: !0, t: w},
    ...
    function j(t, f, o) {
        var l, u, a, c, i, s, e, p, d = window.navigator.pointerEnabled ? {
            ...
            w = f.documentElement || x.documentElement, C = x.body, N = -1, U = 0, M = 1, k = 2,
        ...
        function V(t, e) {
            var r = P(t, f.cssClasses.origin), n = P(r, f.cssClasses.handle);
            return P(n, f.cssClasses.touchArea), n.setAttribute("data-handle", e), f.keyboardSupport && (n.setAttribute("tabindex", "0"), n.addEventListener("keydown", function (t) {
                return function (t, e) {
                    if (O() || z(e)) return !1;
        ...
        function r(t, e) {
            return !!f.tooltips[e] && P(t.firstChild, f.cssClasses.tooltip)
        }
        ...
        function F(e, i, o) {
            ...
            s[U] = f.cssClasses.valueNormal, s[M] = f.cssClasses.valueLarge, s[k] = f.cssClasses.valueSub;
            var l = [];
            l[U] = f.cssClasses.markerNormal, l[M] = f.cssClasses.markerLarge, l[k] = f.cssClasses.markerSub;
            ...
            return ht(a, f.cssClasses.pips), ht(a, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical), Object.keys(e).forEach(function (t) {
                !function (t, e, r) {
                    if ((r = i ? i(e, r) : r) !== N) {
                        var n = P(a, !1);
                        n.className = p(r, f.cssClasses.marker), n.style[f.style] = t + "%", U < r && ((n = P(a, !1)).className = p(r, f.cssClasses.value), n.setAttribute("data-value", e), n.style[f.style] = t + "%", n.innerHTML = o.to(e))
                    }
                }(t, e[t][0], e[t][1])
            }), a
        }
            ...
            var m, g, v, b, e, r, S, x, w, n = t.mode, i = t.density || 1, o = t.filter || !1, a = function (t, e, r) {
                ...
                s = (m = i, g = n, v = a, b = {}, e = E.xVal[0], r = E.xVal[E.xVal.length - 1], x = S = !1, w = 0, (v = v.slice().sort(function (t, e) {
                    ...
                    if (h && (r = E.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d) for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
                        ...
                        l = -1 < v.indexOf(n) ? M : h ? k : U, !e && S && (l = 0), n === d && x || (b[o.toFixed(5)] = [n, l]), w = o
                    }
        ...
        function q(n, i, o, a) {
            var e = function (t) {
                ...
                }(t, a.pageOffset, a.target || i)) && (!(O() && !a.doNotReject) && (e = y, r = f.cssClasses.tap, !((e.classList ? e.classList.contains(r) : new RegExp("\\b" + r + "\\b").test(e.className)) && !a.doNotReject) && (!(n === d.start && void 0 !== t.buttons && 1 < t.buttons) && ((!a.hover || !t.buttons) && (h || t.preventDefault(), t.calcPoint = t.points[f.ort], void o(t, a))))));
                var e, r
            }, r = [];
        ...
        function n(t) {
            t.stopPropagation();
            var i, o, a, e = B(t.calcPoint), r = (i = e, a = !(o = 100), u.forEach(function (t, e) {
                if (!z(e)) {
        ...
        function K(t, e, r, n, i, o) {
            return 1 < u.length && !f.events.unconstrained && (n && 0 < e && (r = Math.max(r, t[e - 1] + f.margin)), i && e < u.length - 1 && (r = Math.min(r, t[e + 1] - f.margin))), 1 < u.length && f.limit && (n && 0 < e && (r = Math.min(r, t[e - 1] + f.limit)), i && e < u.length - 1 && (r = Math.max(r, t[e + 1] - f.limit))), f.padding && (0 === e && (r = Math.max(r, f.padding[0])), e === u.length - 1 && (r = Math.min(r, 100 - f.padding[1]))), r = ft(r = E.getStep(r)), f.isMinMaxEqual && 2 === u.length && (r = 0), !(r === t[e] && !o) && r
        }
        ...
        return ht(e = y, f.cssClasses.target), 0 === f.dir ? ht(e, f.cssClasses.ltr) : ht(e, f.cssClasses.rtl), 0 === f.ort ? ht(e, f.cssClasses.horizontal) : ht(e, f.cssClasses.vertical), l = P(e, f.cssClasses.base), function (t, e) {
            var r = P(e, f.cssClasses.connects);
            u = [], (a = []).push(L(r, t[0]));
            for (var n = 0; n < f.handles; n++) u.push(V(e, n)), v[n] = n, a.push(L(r, t[n + 1]))
            ...
            v.forEach(function (t) {
                var e = u[t], r = K(g, t, 0, !0, !0, !0), n = K(g, t, 100, !0, !0, !0), i = s[t],
                    o = f.ariaFormat.to(a[t]);
                r = E.fromStepping(r).toFixed(1), n = E.fromStepping(n).toFixed(1), i = E.fromStepping(i).toFixed(1), e.children[0].setAttribute("aria-valuemin", r), e.children[0].setAttribute("aria-valuemax", n), e.children[0].setAttribute("aria-valuenow", i), e.children[0].setAttribute("aria-valuetext", o), f.ariaLabel && f.ariaLabel.length && e.children[0].setAttribute("title", f.ariaLabel[t])
            })
        }), s = {
            destroy: function () {
