...
!function (a, e) {
    ...
    function h(e) {
        if (e.settings.infoText) {
            var t = e.elements.select1.find("option").length, n = e.elements.select2.find("option").length,
                i = e.element.find("option").length - e.selectedElements, s = e.selectedElements, l = "";
    ...
    function d(s, l) {
        if (s.settings.showFilterInputs) {
            ...
            var o = new RegExp(a.trim(s.elements["filterInput" + l].val()), "gi"), r = s.element.find("option"),
                e = s.element;
    ...
    function f(e) {
        ...
        t.sort(function (e, t) {
            var n = parseInt(e.getAttribute("data-sortindex")), i = parseInt(t.getAttribute("data-sortindex"));
